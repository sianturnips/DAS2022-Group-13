...
table2<-data%>%
  tabyl(other_colors, thousandRiyals)%>%
  adorn_percentages() %>%
...
```{r barchart4,echo=FALSE, eval=TRUE, warning=FALSE, message=FALSE, out.width='70%',fig.align='center', fig.pos='H', fig.cap="\\label{fig:barchart3} Proportion of Items Availbale in Online and if the Price is Greater than 1000 Riyals." }
